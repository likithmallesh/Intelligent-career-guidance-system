...
// Redirect if a regular user is already logged in
if (isset($_SESSION['user_id']) && $_SESSION['role'] == 'user') {
    header('Location: user/dashboard.php');
    exit;
}
// If an admin is logged in and somehow lands here, redirect them to admin dashboard
...
<body>
    <div class="login-container">
        ...
        <p class="link-text">Are you an administrator? <a href="admin_login.php">Login here</a>.</p>
    </div>
</body>
</html>
